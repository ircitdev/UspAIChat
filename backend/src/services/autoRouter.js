...
const TIER_MODELS = {
  SIMPLE: [
    { provider: 'openai',   model: 'gpt-4.1-nano',                    name: 'GPT-4.1 Nano',          costPer1k: 0.2 },
    { provider: 'gemini',   model: 'gemini-2.0-flash',                name: 'Gemini 2.0 Flash',      costPer1k: 0.15 },
    { provider: 'openai',   model: 'gpt-4o-mini',                     name: 'GPT-4o Mini',           costPer1k: 0.3 },
    { provider: 'deepseek', model: 'deepseek-chat',                   name: 'DeepSeek V3',           costPer1k: 0.4 },
    { provider: 'anthropic',model: 'claude-haiku-4-5-20251001',       name: 'Claude Haiku 4.5',      costPer1k: 1.5 },
    { provider: 'kimi',     model: 'moonshot-v1-8k',                  name: 'Kimi 8K',               costPer1k: 1.3 },
  ],
  MEDIUM: [
    { provider: 'gemini',   model: 'gemini-2.5-flash-preview-05-20',  name: 'Gemini 2.5 Flash',      costPer1k: 0.3 },
    { provider: 'openai',   model: 'gpt-4.1-mini',                    name: 'GPT-4.1 Mini',          costPer1k: 0.6 },
    { provider: 'openai',   model: 'gpt-4.1',                         name: 'GPT-4.1',               costPer1k: 4.0 },
    { provider: 'anthropic',model: 'claude-sonnet-4-6',               name: 'Claude Sonnet 4.6',     costPer1k: 5.0 },
    { provider: 'openai',   model: 'o4-mini',                         name: 'o4 Mini',               costPer1k: 5.0 },
    { provider: 'gemini',   model: 'gemini-2.5-pro-preview-05-06',    name: 'Gemini 2.5 Pro',        costPer1k: 3.0 },
    { provider: 'deepseek', model: 'deepseek-chat',                   name: 'DeepSeek V3',           costPer1k: 0.4 },
  ],
  COMPLEX: [
    { provider: 'anthropic',model: 'claude-opus-4-6',                 name: 'Claude Opus 4.6',       costPer1k: 25.0 },
    { provider: 'openai',   model: 'o3',                              name: 'o3',                    costPer1k: 25.0 },
    { provider: 'anthropic',model: 'claude-sonnet-4-6',               name: 'Claude Sonnet 4.6',     costPer1k: 5.0 },
    { provider: 'gemini',   model: 'gemini-2.5-pro-preview-05-06',    name: 'Gemini 2.5 Pro',        costPer1k: 3.0 },
    { provider: 'openai',   model: 'o3-mini',                         name: 'o3 Mini',               costPer1k: 5.0 },
    { provider: 'deepseek', model: 'deepseek-reasoner',               name: 'DeepSeek R1',           costPer1k: 0.8 },
  ],
};
