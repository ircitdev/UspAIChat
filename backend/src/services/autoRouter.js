...
const TIER_MODELS = {
  SIMPLE: [
    { provider: 'gemini',   model: 'gemini-1.5-flash-latest', name: 'Gemini 1.5 Flash',  costPer1k: 0.35 },
  ...
  MEDIUM: [
    ...
    { provider: 'gemini',   model: 'gemini-1.5-pro-latest',   name: 'Gemini 1.5 Pro',    costPer1k: 3.5 },
